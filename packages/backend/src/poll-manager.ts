    ...
    const doPoll = async () => {
      try {
        ...
        if (serviceId === 'bazarr') {
          ...
          this.nasData = { ...nasResult, imageUpdateAvailable: this.nasData.imageUpdateAvailable, imageUpdateDetails: this.nasData.imageUpdateDetails, imageUpdateCheckedAt: this.nasData.imageUpdateCheckedAt }
